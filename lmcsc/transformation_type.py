...
class TransformationType:
    def __init__(self, vocab, is_bytes_level, shape_similar_threshold=0.45):
        # # https://github.com/kfcd/chaizi/blob/master/chaizi-jt.txt
        # self.radical_dict = self.load_dict("data/radical_dict.json")

        # # https://github.com/houbb/nlp-hanzi-similar/blob/master/src/main/resources/nlp/sijiaobianma_2w.txt
        # self.four_corner_dict = self.load_dict("data/four_corner_dict.json")
        ...
        # self.shape_confusion_dict = self.load_dict("data/wang_confusion_dict.json")
